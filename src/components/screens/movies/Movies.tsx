...
import { Dispatch, FC, ForwardedRef, forwardRef, SetStateAction } from "react";
...
import useMovieFiltering from "@/components/hooks/useMovieFiltering";

interface IMoviesProps {
  movies: IMovie[];
  ref?: ForwardedRef<HTMLAnchorElement>;
  setSelectedGenre?: (item: string) => Dispatch<SetStateAction<null>>;
}

const Movies: FC<IMoviesProps> = forwardRef(
  ({ movies, selectedGenre, setSelectedGenre }, ref) => {
    ...
    const { genres } = useMovieFiltering();
